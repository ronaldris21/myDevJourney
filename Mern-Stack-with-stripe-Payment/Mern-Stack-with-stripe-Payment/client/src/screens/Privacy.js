        ...
        <div className="bg-white my-12">
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                At OnlineShop Market, accessible from OnlineShop Market dot com,
                one of our main priorities is the privacy of our visitors. This
                Privacy Policy document contains types of information that is
                collected and recorded by OnlineShop Market and how we use it.
              ...
              <p>
                ...
                information that they shared and/or collect in OnlineShop
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                OnlineShop Market follows a standard procedure of using log
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                ...
                the advertising partners of OnlineShop Market. Third-party ad
                servers or ad networks uses technologies like cookies,
                JavaScript, or Web Beacons that are used in their respective
                advertisements and links that appear on OnlineShop Market, which
                ...
                that you visit. Note that OnlineShop Market has no access to or
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                ...
                respective advertisements and links that appear on OnlineShop
                ...
                OnlineShop Market has no access to or control over these cookies
                that are used by third-party advertisers.
              </p>
              <p>
                OnlineShop Market's Privacy Policy does not apply to other
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              ...
              <p>
                OnlineShop Market does not knowingly collect any Personal
